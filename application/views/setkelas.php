    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Master Kelas</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<script type="text/javascript">
    ...
    $(function () {
        $('#formUser').on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?php  echo base_url(); ?>kelas/data_simpan",
                type: "POST",
    ...
    function hapusData() {
        ...
        $.ajax({
            url: "<?php  echo base_url(); ?>kelas/data_hapus",
            type: "POST",
            data:  {id,id},
            dataType:'json', 
            success: function(data)
    ...
    function updateKelas(id) {
        ...
        $.ajax({
            type: "POST",
            url: '<?php  echo base_url(); ?>kelas/data_detail',
            data:{
                id:id
            },
            dataType:'json',
