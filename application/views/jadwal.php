            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title ">Data Jadwal Ujian Calon Siswa</h4>
                    <button class="btn btn-info btn-sm float-right" onclick="refreshData()">Refresh <i class="fa fa-redo"></i></button>
                    <button class="btn btn-success btn-sm float-right" onclick="tambahData()">Buat Jadwal <i class="fa fa-calendar"></i></button>
          ...
          <div class="modal-content">          
            ...
            <div class="modal-body">
              ...
              <div>
                  ...
                  <input type="text" name="nama_tes" id="nama_tes" class="form-control" required />
              </div>
              <div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready( function () {
      ...
      var table= $('#santritable').DataTable({
        ...
        order: [],
        ajax: {
          url: "<?php echo site_url('santri/jadwal_data')?>",
          type: "POST"
        },
        "columnDefs": [{
