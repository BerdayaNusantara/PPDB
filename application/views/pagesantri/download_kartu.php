                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                                <img src="<?php echo base_url();?>asset/image/bgkartu.jpg" style="max-width:100%"/>
                                <p style="position: absolute;top: 15%;font-style:bold;font-weight:800;color:#001f90;left: 30%;font-size: 25px;">KARTU PESERTA</p>
                                <p style="position: absolute;top: 20%;text-align:center;font-style:bold;font-weight:500;color:#000;left: 20%;font-size: 15px;">TES PENERIMAAN PESERTA DIDIK BARU<br>TAHUN PELAJARAN 2021/2022</p>
                                <table style="position: absolute;top: 30%;left:10%;font-weight:800;">
                                    <tr>
                                        <td>Jenjang </td>
                                        <td>:</td>
                                     ...
                                     <tr>
                                        <td>No.Peserta </td>
                                        <td>:</td>
                                        <td colspan="3"><?php echo $d->kode;?></td>
                                    </tr>
                                     <tr>
                                        <td>Jenis Kelamin </td>
                                        <td>:</td>
                                        <td colspan="3"><?php echo $d->jenis_kelamin;?></td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" style="text-align:center;">Jadwal Tes</td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" style="text-align:center;"><?php echo $tanggal_ujian; ?></td>
                                    </tr>
                                </table>
                            </div>
                    <div class="col-sm-3">
