...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Silahkan masukkan email atau whatsapp dan password</p>

      <form method="post"  id="formLogin">
        <div class="input-group mb-3">
          <input type="text" name="email"  class="form-control" placeholder="Email atau Nomor Whatsapp">
      ...
      <p class="mb-1"><br>
        <a href="<?php echo base_url();?>home/forgetpassword">Lupa Password?</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
...
<script type="text/javascript">
      $(function () {
        $('#formLogin').on('submit', function (e) {
          e.preventDefault();
          $.ajax({
            url: "<?php  echo base_url(); ?>loginsantri/proses",
            type: "POST",
