            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  <p class="card-category"><i class="fa fa-user-tie "></i>  Jumlah Pendaftar</p>
                  <h3 class="card-title"><?php echo $jumlah_siswa;?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <a href="<?php echo base_url();?>backoffice/santri" class="btn btn-sm btn-success">Lihat daftar calon siswa</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  <p class="card-category"><i class="fa fa-money-bill-wave"></i>  Pembayaran Selesai</p>
                  <h3 class="card-title"><?php echo "Rp. ".number_format($jumlah_berhasil);?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <a href="<?php echo base_url();?>backoffice/pembayaran" class="btn btn-sm btn-success">Lihat daftar pembayaran</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  <p class="card-category"><i class="fa fa-money-bill-wave"></i>  Pembayaran Pending</p>
