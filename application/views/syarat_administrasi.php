    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Syarat Administrasi</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title ">Syarat Administrasi</h4>
      ...
      <div class="modal-dialog">
        <div class="modal-content">          
          ...
          <div class="modal-header">
            <h4 class="modal-title">Tambah Data Syarat Administrasi</h4>
          ...
          <div class="modal-body">
            <div>
              ...
              <textarea name="nama" id="nama" class="form-control" require></textarea>
            </div>
          </div>
          <!-- Modal footer -->
...
<script type="text/javascript">
    $(document).ready( function () {
        $('#usertable').DataTable({
            ...
            order: [],
            ajax: {
                url: "<?php echo site_url('konten/data_syarat')?>",
                type: "POST"
            },
            "columnDefs": [{
    ...
    function tambahData() {
        $('#id').val("");
        var modal = $("#modalUser");
        modal.find('.modal-title').text('Tambah Data Syarat Administrasi');
        $("#modalUser").modal();
    };
    ...
    $(function () {
        $('#formUser').on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?php  echo base_url(); ?>konten/syarat_simpan",
                type: "POST",
    ...
    function hapusData() {
        ...
        $.ajax({
            url: "<?php  echo base_url(); ?>konten/syarat_hapus",
            type: "POST",
            data:  {id,id},
            dataType:'json', 
            success: function(data)
    ...
    function updateSyarat(id) {
        $('#id').val(id);
        var modal = $("#modalUser");
        modal.find('.modal-title').text('Edit Data Syarat Administrasi');
        modal.modal();
        $.ajax({
            type: "POST",
            url: '<?php  echo base_url(); ?>konten/syarat_detail',
            data:{
                id:id
            },
            dataType:'json',
