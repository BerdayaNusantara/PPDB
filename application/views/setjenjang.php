    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Pengaturan Jenjang</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="modal-content">          
          ...
          <div class="modal-body">
            ...
            <div>
              ...
              <img  id="logo_view" name="logo_view" src="<?php echo base_url();?>assets/image_def.png" width="100"/>
            </div>
          </div>
          <!-- Modal footer -->
...
<script type="text/javascript">
    $(document).ready( function () {
        $('#usertable').DataTable({
            ...
            order: [],
            ajax: {
                url: "<?php echo site_url('jenjang/data_list')?>",
                type: "POST"
            },
            "columnDefs": [{
    ...
    function tambahData() {
        $('#id').val("");
        var modal = $("#modalUser");
        modal.find('.modal-title').text('Tambah Data Jenjang');
        $("#modalUser").modal();
    };
    ...
    $(function () {
        $('#formUser').on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?php  echo base_url(); ?>jenjang/data_simpan",
                type: "POST",
    ...
    function hapusData() {
        ...
        $.ajax({
            url: "<?php  echo base_url(); ?>jenjang/data_hapus",
            type: "POST",
            data:  {id,id},
            dataType:'json', 
            success: function(data)
    ...
    function updateJenjang(id) {
        $('#id').val(id);
        var modal = $("#modalUser");
        modal.find('.modal-title').text('Edit Data Jenjang');
        modal.modal();
        $.ajax({
            type: "POST",
            url: '<?php  echo base_url(); ?>jenjang/data_detail',
            data:{
                id:id
            },
            dataType:'json',
            success: function(data) {
                $.each(data.hasildata,function(i,v){
                    ...
                    if(v.logo!="")
                    {
                      $("#logo_view").attr("src", "/upload/logo/"+v.logo);
                    }
                });
            }
        });
