                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      ...
                      <div>
                        ...
                        <input type="text" name="telp" id="telp" value="<?php echo $telp;?>" class="form-control"/>
                      </div>
                      <div>
                        <label>Email</label>
                      ...
                      <div>
                        ...
                        <textarea name="alamat" id="alamat" class="form-control"><?php echo $alamat;?>
                        </textarea>
                      </div>
                      <div>
                        <label>Logo</label>
                        ...
                        <?php if($logo==""){?>
                            <img src="/upload/image_def.png" width="100"/>
                        <?php }else{ ?>
                            <img src="/upload/logo/<?php echo $logo; ?>" width="100"/>
                        <?php } ?>
                      </div>
                    </div>
                  </div>
    ...
    $(document).ready( function () {
      ...
      $(function () {
        $('#formProfil').on('submit', function (e) {
          e.preventDefault();
          $.ajax({
            url: "<?php  echo base_url(); ?>backoffice/setprofil_update",
            type: "POST",
            ...
            success: function(data){
              if(data.hasil==1){
                ...
                then(function(){
                    window.location.href = "<?php echo base_url();?>backoffice/setprofil";
                });
              }else{
                Swal.fire({
                  icon: 'warning',
