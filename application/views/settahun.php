...
<script type="text/javascript">
    $(document).ready( function () {
        $('#usertable').DataTable({
            ...
            order: [],
            ajax: {
                url: "<?php echo site_url('backoffice/data_list_tahun')?>",
                type: "POST"
            },
            "columnDefs": [{
    ...
    function tambahData() {
        $('#id').val("");
        var modal = $("#modalUser");
        modal.find('.modal-title').text('Tambah Data Tahun');
        $("#modalUser").modal();
    };
    ...
    $(function () {
        $('#formUser').on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?php  echo base_url(); ?>backoffice/data_simpan_tahun",
                type: "POST",
    ...
    function hapusData() {
        ...
        $.ajax({
            url: "<?php  echo base_url(); ?>backoffice/data_hapus_tahun",
            type: "POST",
            data:  {id,id},
            dataType:'json', 
            success: function(data)
    ...
    function updateTahun(id) {
        $('#id').val(id);
        var modal = $("#modalUser");
        modal.find('.modal-title').text('Edit Data Tahun');
        modal.modal();
        $.ajax({
            type: "POST",
            url: '<?php  echo base_url(); ?>backoffice/data_detail_tahun',
            data:{
                id:id
            },
            dataType:'json',
