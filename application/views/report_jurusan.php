    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Report per Jurusan</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  ...
                  <br>
                  <div class="col-sm-4">
                  <select class="form-control" id="jenjang" onchange="filterjur()" name="jenjang">
                    <option value="">Pilih Jenjang</option>
                    <?php foreach($data_jurusan as $dj){?>
    ...
    function filterjur()
    {
        ...
        if ($.fn.DataTable.isDataTable( '#santritable' ) ) {
            ...
            dtsantritable = $('#santritable').DataTable({
                ...
                order: [],
                ajax: {
                    url: "<?php echo site_url('santri/data_list_report_jurusan')?>",
                    type: "POST",
                    data:{
                        jenjang:jurusan
                    }
    ...
    function showdata()
    {
        if ($.fn.DataTable.isDataTable( '#santritable' ) ) {
            ...
            dtsantritable = $('#santritable').DataTable({
              ...
              order: [],
              ajax: {
                url: "<?php echo site_url('santri/data_list_report')?>",
                type: "POST"
              },
              "columnDefs": [{
              "targets": [ 0 ], //first column / numbering column
