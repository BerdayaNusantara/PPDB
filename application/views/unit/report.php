    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0 text-dark">Report Siswa <?php echo $nama_jenjang;?></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title ">Data Calon Siswa <?php echo $nama_jenjang;?></h4>
  ...
  <script type="text/javascript">
    $(document).ready( function () {
            $('#santritable').DataTable({
              ...
              order: [],
              ajax: {
                url: "<?php echo site_url('unit/data_list_santri')?>",
                type: "POST"
              },
              "columnDefs": [{
