    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Pengaturan Nomor Pendaftaran</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title ">Pengaturan Nomor Pendaftaran</h4> 
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-12">
                      <div>
                        <label>Karakter Awal</label>
                        <input type="hidden" name="id" id="id" value="<?php echo $id;?>" class="form-control"/>
                        <input type="text" name="nomor_daftar" id="nomor_daftar" value="<?php echo $nomor_daftar;?>" class="form-control"/>
                      </div>
                    </div>
                  </div>
    ...
    $(document).ready( function () {
      ...
      $(function () {
        $('#formAPI').on('submit', function (e) {
          e.preventDefault();
          $.ajax({
            url: "<?php  echo base_url(); ?>backoffice/setnomor_update",
            type: "POST",
