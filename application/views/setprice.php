    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Pengaturan Biaya</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title ">Pengaturan Biaya</h4> 
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div>
                        ...
                        <input type="text" name="biaya" id="biaya" value="<?php echo $biaya;?>" class="form-control"/>
                      </div>
                    </div>
                  </div>
    ...
    $(document).ready( function () {
      ...
      $(function () {
        $('#formUser').on('submit', function (e) {
          e.preventDefault();
          $.ajax({
            url: "<?php  echo base_url(); ?>backoffice/setprice_update",
            type: "POST",
