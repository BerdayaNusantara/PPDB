      ...
      <div class="modal-dialog">
        <div class="modal-content">          
          ...
          <div class="modal-body">
            ...
            <div>
              <label>Level</label>
              <select class="form-control" name="level" id="level" required onchange="pilihJenjang()">
                  <option value="">Pilih Level</option>
                  <option value="Administrator">Administrator</option>
                  <option value="Jenjang">Jenjang</option>
              </select>
            </div>
            <div style="display:none;" id="div_jenjang">
              <label>Jenjang</label>
            ...
            $.ajax({
              ...
              success: function(data) {
                $.each(data.hasildata,function(i,v){
                  ...
                  if(v.level=="Jenjang")
                  {
                    document.getElementById("div_jenjang").style.display="unset";
                  }else{
                    document.getElementById("div_jenjang").style.display="none";
                  }
                  if(v.foto!=""){
