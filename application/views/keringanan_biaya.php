    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Keringanan Biaya</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<script type="text/javascript">
    $(document).ready( function () {
        $('#usertable').DataTable({
            ...
            order: [],
            ajax: {
                url: "<?php echo site_url('konten/data_keringanan')?>",
                type: "POST"
            },
            "columnDefs": [{
    ...
    function tambahData() {
        $('#id').val("");
        var modal = $("#modalUser");
        modal.find('.modal-title').text('Tambah Data Keringanan');
        $("#modalUser").modal();
    };
    ...
    $(function () {
        $('#formUser').on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?php  echo base_url(); ?>konten/keringanan_simpan",
                type: "POST",
    ...
    function hapusData() {
        ...
        $.ajax({
            url: "<?php  echo base_url(); ?>konten/keringanan_hapus",
            type: "POST",
            data:  {id,id},
            dataType:'json', 
            success: function(data)
    ...
    function updateKeringanan(id) {
        $('#id').val(id);
        var modal = $("#modalUser");
        modal.find('.modal-title').text('Edit Data Keringanan');
        modal.modal();
        $.ajax({
            type: "POST",
            url: '<?php  echo base_url(); ?>konten/keringanan_detail',
            data:{
                id:id
            },
            dataType:'json',
